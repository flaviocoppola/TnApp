    ...
    if (isLoading) {
      ...
      return (
        <View style={styles.container}>
          ...
          <TouchableOpacity
            ...
            <Text style={{color: 'white'}}>Sansiona </Text>
          </TouchableOpacity>
      ...
      return (
        <View style={{flex: 1, justifyContent: 'center', alignItems: 'center'}}>
          <Text style={styles.title}>Viaggio selezionato: {data.VIAGGIO.VIAGGIO_CONSEGNA_NUMERO}/
            {data.VIAGGIO.VIAGGIO_CONSEGNA_FILIALE}/
            {data.VIAGGIO.VIAGGIO_CONSEGNA_ANNO}</Text>
          <Text style={styles.title}>Numero spedizioni: {data.VIAGGIO.SPEDIZIONE.length}</Text>
